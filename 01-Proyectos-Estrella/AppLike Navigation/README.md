...
Fuente de Datos: 🛢️ SQL Server (Database: AdventureWorks).

Páginas: 3 (Executive, Product, Customer).

Consultas 🛢️ SQL: Se añade un archivo con los scripts SQL utilizados para la extracción y pre-procesamiento de datos, garantizando la integridad de la información antes de su modelado en Power BI.
